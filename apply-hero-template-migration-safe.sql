-- Safe HeroTemplate Migration Script
-- This script safely adds missing columns to the HeroTemplates table
-- It checks if columns exist before adding them

-- First, make HeaderOverlayOpacity nullable if it exists
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'HeroTemplates' AND COLUMN_NAME = 'HeaderOverlayOpacity')
BEGIN
    ALTER TABLE HeroTemplates ALTER COLUMN HeaderOverlayOpacity REAL NULL;
    PRINT 'Made HeaderOverlayOpacity nullable';
END
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'HeroTemplates' AND COLUMN_NAME = 'IsActive')
BEGIN
    ALTER TABLE HeroTemplates ADD IsActive BIT NULL;
    PRINT 'Added IsActive';
END

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'HeroTemplates' AND COLUMN_NAME = 'Name')
BEGIN
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'HeroTemplates' AND COLUMN_NAME = 'Template')
BEGIN
